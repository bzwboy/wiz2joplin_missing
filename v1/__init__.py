...
parser.add_argument('--skip-missing-attachments', '-s', action='store_true', help='Skip documents with missing attachments instead of failing.')
...
def main() -> None:
    ...
    ws.resolve(skip_missing_attachments=args.skip_missing_attachments, skip_missing_images=args.skip_missing_attachments)
